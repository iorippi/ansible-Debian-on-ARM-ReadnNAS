...
1. [Setting up for serial connection](#1setting-up-for-serial-connection)
2. [Getting into bootloader via SERIAL connection](#2getting-into-bootloader-via-serial-connection)
3. [Getting into Linux via SERIAL connection](#3getting-into-linux-via-serial-connection)

**[[SSH conenction](#ssh-connection)**
1. [Setting up for SSH connection](#1setting-up-for-ssh-connection)
2. [Gettign into Linux via SSH connection](#2gettign-into-linux-via-ssh-connection)
